...
(function() {
  ...
  MainView = (function(_super) {
    ...
    MainView.prototype.render = function() {
      ...
      _ref3 = _.sortBy(_ref3,"name");
		for(var j =0;j<sp_apis.length;j++){
			var agname = sp_apis[j].group;
			var agheader = sp_apis[j].header;
			var apis = sp_apis[j].apis;
			$('#resources').append("<br><h1>" + agheader + "</h1><br>");
			for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
	        	resource = _ref3[_i];
	        	if(apis.indexOf(resource.name) >= 0){
