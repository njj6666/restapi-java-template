  ...
  SwaggerResource = (function() {
    ...
    SwaggerResource.prototype.addApiDeclaration = function(response) {
      ...
      if ((response.basePath != null) && response.basePath.replace(/\s/g, '').length > 0) {
    	  this.basePath = this.buildUrl(this.basePath, response.basePath);
      }
    ...
    SwaggerResource.prototype.buildUrl = function(base, url) {
        // url start with protocal, use this url directly.
    	if(url.indexOf("http://") === 0 || url.indexOf("https://") === 0) {
        	return url;
        }else {
        	var parts;
            console.log("resource base is " + base);
            parts = base.split("/");
            base = parts[0] + "//" + parts[2] + "/" + parts[3];
            if (url.indexOf("/") === 0) {
                return base + url;
            } else {
                return base + "/" + url;
